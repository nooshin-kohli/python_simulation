...
class leg_control(object):
    ...
    # def stance_swing(self, leg, t_lo, t_ap, delta_time, l0=0.366):
    #     q = leg.q[-1,:]
    #     qdot = leg.qdot[-1,:]
        
    #     x,y,z =  leg.computeFootState(body_part='h',calc_velocity=True)
    #     z = z - 0.4
    #     x_desired = x
    #     y_desired = y

    #     T = (t-t_lo)/(t_ap-t_lo)
    #     z_desired = (l0-0.045)*T + l0*(1-T)
    #     Jc = leg.Jc
    #     des = [x_desired,y_desired,z_desired]
    #     error = des-[x,y,z]
    ...
    #             [0,0.1,0],
    #             [0,0,0.1]]
    #     tau = np.dot(kp_z,error)+np.dot(kd_z,error_dot)
